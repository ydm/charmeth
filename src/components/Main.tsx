            ...
            <div className="row">
                <div className="col-lg">
                    ...
                    <p className="pt-2 fs-5 pb-4 pb-lg-0">
                        <Charm /> is deployed on <a className="text-warning" href="https://etherscan.io/token/0x2dC39D09C1A3850d3a3c9907b51AEe7217771Fb7">Mainnet</a> and <a className="text-warning" href="https://holesky.etherscan.io/token/0x79772dbc1adbee7c5488229d8021e9e2304ce8af">Holesky</a>.
                    </p>
                </div>
                <div className="col-lg">
